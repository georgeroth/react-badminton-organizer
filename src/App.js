...
function App() {
  ...
  const handleInput = (event) => {
    if (event.target.name === "players") {
      ...
      const playersListSplit = event.target.value.split(/\r?\n/)
      const playersListNoEmpty = removeEmptyPlayerNames(playersListSplit)
      setPlayerData(playersListNoEmpty)
...
const removeEmptyPlayerNames = (playersListSplit) => {
    // Removing empty player names generated by empty lines
